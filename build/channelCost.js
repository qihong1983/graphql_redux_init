...
var _channelCost = __webpack_require__(2219);

var actionCreators = _interopRequireWildcard(_channelCost);
...
var ChannelCost = function (_React$Component) {
    _inherits(ChannelCost, _React$Component);

    function ChannelCost(props) {
        _classCallCheck(this, ChannelCost);

        return _possibleConstructorReturn(this, (ChannelCost.__proto__ || Object.getPrototypeOf(ChannelCost)).call(this, props));
    }

    _createClass(ChannelCost, [{
        ...
        key: 'renderChannelGroupList',
        value: function renderChannelGroupList() {
            var arr = [];
            this.props.channelCost.Result.channelGroupList.map(function (v, k) {
                arr.push(_react2.default.createElement(
                    Option,
                    { key: v.id, value: v.channelName.toString() },
                    v.channelName
                ));
            });
            return arr;
        ...
        value: function renderChannelList() {
            var arr = [];
            this.props.channelCost.Result.channelList.map(function (v, k) {
                arr.push(_react2.default.createElement(
                    Option,
                    { key: v.id, value: v.channelName.toString() },
                    v.channelName
        ...
        key: 'searchChannel',
        value: function searchChannel(channelName) {
            var statusData = {
                appCode: '',
                channelCategory: '',
        ...
        value: function changeChannelGroup(channelGroup) {
            var statusData = {
        ...
        key: 'handleUpload',
        value: function handleUpload(info) {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(RangePicker, {
                                defaultValue: [(0, _moment2.default)(this.props.channelCost.Param.startDate, dateFormat), (0, _moment2.default)(this.props.channelCost.Param.endDate, dateFormat)],
                                format: dateFormat,
                                allowClear: false,
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { style: { width: "100%", marginBottom: "20px" }, className: 'channelCostButtonArea' },
                        _react2.default.createElement(
                            _antd.Upload,
                            _extends({ onChange: this.handleUpload.bind(this) }, uploadConfig),
                            _react2.default.createElement(
                                _antd.Button,
                                { type: 'primary' },
                                '\u5BFC\u5165'
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'a',
                                { href: '/manage/channel/download.do', className: 'downloadModel' },
                                '\u4E0B\u8F7D\u6A21\u677F'
                            )
                        )
                    ),
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(ChannelCost);
...
exports.getTableData = exports.setSelectDate = exports.changeChannelName = exports.changeChannelGroup = exports.getChannelList = exports.getChannelGroupList = undefined;
...
var setSelectDate = function setSelectDate(data) {
...
exports.setSelectDate = setSelectDate;
...
if (window.location.search.indexOf("debug") > 0 || window.location.search.indexOf("web_ci") > 0) {
    ...
    // 渠道链列表
    _mockjs2.default.mock("/manage/channel/costList.do", "post", {
        "msg": "返回成功",
        "data|20": [{
            'appCode|1': ['24', '27'],
            channelGroup: '@string',
    ...
    // 文件上传
    _mockjs2.default.mock("/manage/channel/upload.do", "post", {
        "msg": "导入成功",
        "status": true
    });
}
...
//# sourceMappingURL=channelCost.js.map