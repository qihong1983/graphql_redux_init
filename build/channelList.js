...
var ChannelList = function (_React$Component) {
    ...
    _createClass(ChannelList, [{
        ...
        * */
        ...
        value: function getChannelGroupList() {
            var data = {
                appCode: this.props.channelList.Param.appCode,
                channelGroupId: this.props.channelList.Param.channelGroupId,
                channelTypeId: this.props.channelList.Param.channelTypeId,
        ...
        * */
        ...
        value: function renderChannelGroup() {
            var arr = [];
            this.props.channelList.ChannelGroupList.channelGroupList.map(function (v, k) {
                arr.push(_react2.default.createElement(
                    Option,
                    { key: v.id, value: v.id.toString() },
                    v.channelName
        ...
        * */
        ...
        value: function renderChannelList() {
            var arr = [];
            this.props.channelList.ChannelList.channelList.map(function (v, k) {
                arr.push(_react2.default.createElement(
                    Option,
        ...
        value: function dealColumns() {
            ...
            columns[index].render = function (text) {
                return _react2.default.createElement(
                    ...
                    { to: "/manager/channelList/edit/" + text.id },
                    '\u7F16\u8F91'
                );
            };
            return columns;
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                _reactRouter.IndexLink,
                                { to: "/manager/channelList/create", activeClassName: 'active' },
                                '\u65B0\u5EFA'
                            )
                        )
                    ),
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(ChannelList);
