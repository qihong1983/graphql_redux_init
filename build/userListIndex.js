...
var UserListIndex = function (_React$Component) {
	_inherits(UserListIndex, _React$Component);

	function UserListIndex(props) {
		_classCallCheck(this, UserListIndex);

		return _possibleConstructorReturn(this, (UserListIndex.__proto__ || Object.getPrototypeOf(UserListIndex)).call(this, props));
	}

	_createClass(UserListIndex, [{
		...
		value: function getColumns() {
			...
			this.props.userList.listTable.columns.map(function (v, k) {
				if (v.dataIndex == "uid") {
					v.render = function (text, record) {
						return _react2.default.createElement(
							...
							_react2.default.createElement(
								...
								{ to: "/user/list/edit/" + record.uid, activeClassName: 'active' },
								'\u4FEE\u6539'
							),
							_react2.default.createElement('span', { className: 'ant-divider' }),
							_react2.default.createElement(
								'a',
								{ href: 'javascript:void(0);', 'data-uid': record.uid, 'data-email': record.email, onClick: _this2.clickDelete.bind(_this2), className: 'ant-dropdown-link' },
								'\u5220\u9664'
							)
						);
					};
		...
		key: 'deleteSuccess',
		value: function deleteSuccess(bl) {
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					Content,
					{ style: { background: '#ffffff', padding: 24, margin: 0, minHeight: '0px' } },
					_react2.default.createElement(
						_antd.Form,
						{ layout: 'inline' },
						_react2.default.createElement(
							FormItem,
							{ label: '' },
							_react2.default.createElement(_antd.Input, { placeholder: '\u641C\u7D22\u90AE\u7BB1\u524D\u7F00', ref: 'searchName', onChange: this.changeName.bind(this), value: this.props.userList.Param.name,
								addonAfter: _react2.default.createElement(_antd.Icon, { type: 'search' })
							})
						),
						_react2.default.createElement(
							FormItem,
				...
				_react2.default.createElement(
					Content,
					{ style: { background: '#fff', padding: "24px", margin: 24, marginBottom: 0, marginTop: "24px", minHeight: 380 } },
					_react2.default.createElement(
						'div',
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								_reactRouter.IndexLink,
								{ to: "/user/list/create", activeClassName: 'active' },
								'\u65B0\u5EFA'
							)
						)
					),
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(UserListIndex);
...
//# sourceMappingURL=userListIndex.js.map