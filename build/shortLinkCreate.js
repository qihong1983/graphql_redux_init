...
var Create = function (_React$Component) {
    ...
    _createClass(Create, [{
        ...
        value: function renderGroupName() {
            var arr = [];
            this.props.shortLink.Result.groupList.map(function (v, k) {
        ...
        value: function changeChannelGroupId(mid) {
            ...
            var obj = this.props.shortLink.Result.groupList.filter(function (item) {
                return item.id == mid;
            });
            this.props.setCreateParam({
                channelGroupId: mid,
...
//# sourceMappingURL=shortLinkCreate.js.map