...
var _channelList = __webpack_require__(2185);

var actionCreators = _interopRequireWildcard(_channelList);
...
var Edit = function (_React$Component) {
    ...
    _createClass(Edit, [{
        ...
        value: function componentWillMount() {
            ...
            //当前渠道id
            var curId = this.props.routeParams.id;

            //根据当前渠道id获取渠道详情
            this.props.getCurChannelDetail({
                id: curId
            });
        ...
        value: function handleSubmit(e) {
            ...
            e.preventDefault();
            var that = this;
            var curGroupObj = this.props.channelList.GroupList.groupList.filter(function (item) {
        ...
        key: 'createPassword',
        value: function createPassword(minLength, maxLength) {
            var pw = (0, _channelManagerUtil.getRandomPassword)(minLength, maxLength);
            this.props.setEditParam({
                password: pw
            });
        ...
        value: function renderChannelGroup() {
            var arr = [];
            this.props.channelList.GroupList.groupList.map(function (v, k) {
        ...
        value: function renderChannelType() {
            var arr = [];
            this.props.channelList.ChannelTypeList.channelTypeList.map(function (v, k) {
                arr.push(_react2.default.createElement(
                    Option,
                    { key: v.id, value: v.id.toString() },
                    v.name
        ...
        key: 'handleCheckShowCol',
        value: function handleCheckShowCol(e) {
            this.props.setEditParam({
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        _antd.Card,
                        { title: '\u4FEE\u6539\u6E20\u9053', bordered: false, style: { width: "100%" }, noHovering: true },
                        _react2.default.createElement(
                            _antd.Form,
                            { layout: "horizontal", onSubmit: this.handleSubmit.bind(this), style: { maxWidth: "600px" } },
                            _react2.default.createElement(
                                FormItem,
                                _extends({ label: '\u6E20\u9053\u540D\u79F0' }, _formLayoutConfig.formItemLayout),
                                getFieldDecorator('channelName', {
                                    initialValue: this.props.channelList.EditParam.channelName,
                                    rules: [{ required: true, message: '1-32个字符，支持字母、数字和下划线' }, { pattern: /\w{1,32}$/, message: "1-32个字符，支持字母、数字和下划线!" }]
                                })(_react2.default.createElement(_antd.Input, { placeholder: '\u8BF7\u8F93\u5165\u6E20\u9053\u540D\u79F0', disabled: true }))
                            ),
                            _react2.default.createElement(
                                'div',
                                { className: 'loginPasswordRow' },
                                _react2.default.createElement(
                                    FormItem,
                                    _extends({ label: '\u767B\u5F55\u5BC6\u7801' }, _formLayoutConfig.formItemLayout),
                                    getFieldDecorator('password', {
                                        rules: [{ pattern: /\S{6,12}$/, message: "6-12个字符，支持字母、数字和特殊字符" }]
                                    })(_react2.default.createElement(_antd.Input, { placeholder: '\u8BF7\u8F93\u5165\u767B\u5F55\u5BC6\u7801', onChange: this.changePassword.bind(this) }))
                                ),
                                _react2.default.createElement(
                                    _antd.Button,
                                    { type: 'primary', onClick: this.createPassword.bind(this, 6, 12) },
                                    '\u968F\u673A\u751F\u6210'
                                )
                            ),
                            _react2.default.createElement(
                                FormItem,
                                _extends({ label: '\u6E20\u9053\u7EC4\u540D\u79F0' }, _formLayoutConfig.formItemLayout),
                            ...
                            _react2.default.createElement(
                                FormItem,
                                _extends({ label: '\u64CD\u4F5C\u7CFB\u7EDF' }, _formLayoutConfig.formItemLayout),
                            ...
                            _react2.default.createElement(
                                FormItem,
                                _extends({ label: '\u7EBF\u4E0A\\\u7EBF\u4E0B' }, _formLayoutConfig.formItemLayout),
                            ...
                            _react2.default.createElement(
                                FormItem,
                                _extends({ label: '\u6E20\u9053\u7C7B\u578B' }, _formLayoutConfig.formItemLayout),
                            ...
                            _react2.default.createElement(
                                FormItem,
                                _extends({ label: '\u662F\u5426\u4ED8\u8D39' }, _formLayoutConfig.formItemLayout),
                            ...
                            _react2.default.createElement(
                                FormItem,
                                _extends({ label: '\u6263\u91CF\u7CFB\u6570' }, _formLayoutConfig.formItemLayout),
                                getFieldDecorator('reduce', {
                                    rules: [{ pattern: /[0-100]$/, message: "只能0到100之间的整数" }],
                                    initialValue: this.props.channelList.EditParam.reduce
                                })(_react2.default.createElement(_antd.Input, { addonAfter: '%', onChange: this.changeReduce.bind(this) }))
                            ),
                            _react2.default.createElement(
                                FormItem,
                                _extends({ label: '\u5BF9\u5916\u6307\u6807' }, _formLayoutConfig.formItemLayout),
                                _react2.default.createElement(
                                    _antd.Checkbox,
                                    { onChange: this.handleCheckShowCol.bind(this),
                            ...
                            _react2.default.createElement(
                                FormItem,
                                _extends({ label: '\u63CF\u8FF0' }, _formLayoutConfig.formItemLayout),
                                _react2.default.createElement(TextArea, { value: this.props.channelList.EditParam.channelDescribe, onChange: this.changeDescription.bind(this) })
                            ),
                            _react2.default.createElement(
                                FormItem,
...
exports.getChannelGroupList = undefined;
...
var _addKey = __webpack_require__(2180);
...
var create = function create(data) {
    ...
    return function (dispatch) {
        ...
        (0, _reqwest2.default)({
            ...
            window.location.href = '/#/manager/channelList';
        });
    };
};
...
exports.changeChannelCategory = undefined;

var _getChannelTypeList = __webpack_require__(2162);

var _getChannelGroupList = __webpack_require__(2155);

var _getChannelList = __webpack_require__(2153);
...
var changeChannelCategory = function changeChannelCategory(data) {
    ...
    return function (dispatch) {
        ...
        dispatch((0, _getChannelList.getChannelList)(channelListdata));
        ...
        dispatch((0, _getChannelGroupList.getChannelGroupList)(channelGroupData));
...
exports.changeChannelGroup = undefined;
...
exports.changeChannelType = undefined;
...
exports.nameCheck = exports.getCurChannelDetail = exports.edit = exports.setEditParam = exports.create = exports.setCreateParam = exports.getCurGroupOfForm = exports.getGroupList = exports.setPagination = exports.setLimit = exports.getTableData = exports.changeChannelType = exports.changeChannelGroup = exports.changeChannelCategory = exports.changeOs = exports.getChannelList = exports.getChannelGroupList = exports.getChannelTypeList = undefined;
...
var _changeOs = __webpack_require__(2184);

var _changeChannelCategory = __webpack_require__(2181);

var _changeChannelGroup = __webpack_require__(2182);

var _changeChannelType = __webpack_require__(2183);

var _getTableData = __webpack_require__(2163);

var _setLimit = __webpack_require__(2193);

var _setPagination = __webpack_require__(2194);

var _getGroupList = __webpack_require__(2189);

var _getCurGroupOfForm = __webpack_require__(2188);

var _setCreateParam = __webpack_require__(2191);

var _create = __webpack_require__(2165);

var _setEditParam = __webpack_require__(2192);

var _edit = __webpack_require__(2186);

var _getCurChannelDetail = __webpack_require__(2187);

var _namecheck = __webpack_require__(2190);

exports.getChannelTypeList = _getChannelTypeList.getChannelTypeList;
exports.getChannelGroupList = _getChannelGroupList.getChannelGroupList;
...
exports.changeChannelGroup = _changeChannelGroup.changeChannelGroup;
...
exports.getCurGroupOfForm = _getCurGroupOfForm.getCurGroupOfForm;
...
exports.getCurChannelDetail = _getCurChannelDetail.getCurChannelDetail;
exports.nameCheck = _namecheck.nameCheck;
...
exports.getCurChannelDetail = undefined;
 ...
 * @return {Function}
 */
var getCurChannelDetail = function getCurChannelDetail(data) {
...
exports.getCurChannelDetail = getCurChannelDetail;
...
exports.getCurGroupOfForm = undefined;
 ...
 * @return {Function}
 */
var getCurGroupOfForm = function getCurGroupOfForm(data, callback) {
...
exports.getCurGroupOfForm = getCurGroupOfForm;
 ...
 * @return {Function}
 */
var nameCheck = function nameCheck(checkData, createData) {
    ...
    return function (dispatch) {
        ...
        (0, _reqwest2.default)({
            ...
            if (msg.state == "success") {
                dispatch((0, _create.create)(createData));
            } else {
...
//# sourceMappingURL=channelListEdit.js.map