    ...
    _createClass(Create, [{
        ...
        value: function handleSubmit(e) {
            ...
            this.props.form.validateFieldsAndScroll(function (err, values) {
                if (!err) {
                    _this3.props.nameCheck(checkData, createData);
                }
            });
        }
        ...
        value: function changeChannelName(e) {
        ...
        key: 'changeChannelGroupId',
        value: function changeChannelGroupId(mid) {
            var _this = this;
            this.props.getCurGroupOfForm({
                id: mid
            }, function () {
                var obj = _this.props.channelList.GroupList.groupList.filter(function (item) {
                    return item.id == mid;
                });
        ...
        key: 'renderGroupName',
        value: function renderGroupName() {
            var arr = [];
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        _antd.Card,
                        { title: '\u65B0\u5EFA\u6E20\u9053', bordered: false, style: { width: "100%" }, noHovering: true },
                        _react2.default.createElement(
                            _antd.Form,
                            ...
                            _react2.default.createElement(
                                ...
                                })(_react2.default.createElement(_antd.Input, { placeholder: '\u8BF7\u8F93\u5165\u6E20\u9053\u540D\u79F0', onChange: this.changeChannelName.bind(this) }))
                            ),
                            _react2.default.createElement(
                                'div',
                                ...
                                _react2.default.createElement(
                                    ...
                                    getFieldDecorator('password', {
                                        rules: [{ required: true, message: '6-12个字符，支持字母、数字和特殊字符' }, { pattern: /\S{6,12}$/, message: "6-12个字符，支持字母、数字和特殊字符" }]
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(TextArea, { onChange: this.changeDescription.bind(this) })
                            ),
                            _react2.default.createElement(
                                FormItem,
...
//# sourceMappingURL=channelListcreate.js.map