...
var createUser = function (_React$Component) {
	...
	function createUser(props) {
		...
		return _possibleConstructorReturn(this, (createUser.__proto__ || Object.getPrototypeOf(createUser)).call(this, props));
	}
		...
		value: function handleSubmit(e) {
			...
			this.props.form.validateFields(function (err, values) {
				if (!err) {
					...
					_this2.props.uniqueUser(data, _this2.addUser.bind(_this2));
				}
			});
		}
	}, {
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						_antd.Card,
						{ title: '\u65B0\u5EFA\u7528\u6237', bordered: false, style: { width: "100%" }, noHovering: true },
						_react2.default.createElement(
							_antd.Form,
							...
							_react2.default.createElement(
								...
								getFieldDecorator('textEmail', {
									rules: [{ required: true, message: '请输入你的邮箱前缀!' }, { pattern: /^[\w-]+(\.[\w]+)*$/, message: "请正确输入邮箱地址!" }],
									initialValue: this.props.userList.addUser.email
								})(_react2.default.createElement(_antd.Input, { type: 'textEmail', addonAfter: '@corp.netease.com', onChange: this.changeEmail.bind(this), placeholder: '\u8BF7\u8F93\u5165\u4F60\u7684\u90AE\u7BB1\u524D\u7F00' }))
							),
							_react2.default.createElement(
								FormItem,
								...
								})(_react2.default.createElement(CheckboxGroup, { type: 'remember', value: this.props.userList.addUser.auth, onChange: this.changeRemember.bind(this), options: options }))
							),
							_react2.default.createElement(
								FormItem,
...
createUser = _antd.Form.create()(createUser);
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(createUser);
