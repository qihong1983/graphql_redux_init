...
var ModelManager = function (_React$Component) {
    _inherits(ModelManager, _React$Component);

    function ModelManager(props) {
        _classCallCheck(this, ModelManager);

        return _possibleConstructorReturn(this, (ModelManager.__proto__ || Object.getPrototypeOf(ModelManager)).call(this, props));
    }
    ...
    _createClass(ModelManager, [{
        ...
        value: function componentWillUpdate(nextProps) {
            if (nextProps.modelManager.Result.downloadDataList != this.props.modelManager.Result.downloadDataList) {
                ...
                var downloadTitles = (0, _channelManagerUtil.dealDownloadTitle)(this.props.modelManager.TableColumns.tableColumns);
                var helperColumns = (0, _channelManagerUtil.dealDownloadColumns)(this.props.modelManager.TableColumns.tableColumns);
                var downloadDatas = (0, _channelManagerUtil.dealDownloadData)(nextProps.modelManager.Result.downloadDataList, helperColumns);
        ...
        key: 'renderBrandList',
        value: function renderBrandList() {
            var arr = [];
            this.props.modelManager.Result.brandList.map(function (v, k) {
                arr.push(_react2.default.createElement(
                    Option,
                    { key: v.id, value: v.brand.toString() },
                    v.brand
                ));
            });
            return arr;
        ...
        key: 'changeOs',
        value: function changeOs(curAppCode) {
            var statusData = {
                appCode: curAppCode,
                deviceModel: '',
                firm: '',
        ...
        key: 'changeModel',
        value: function changeModel(curDeviceModel) {
        ...
        key: 'changeBrand',
        value: function changeBrand(curBrand) {
            var statusData = {
                appCode: this.props.modelManager.Param.appCode,
                deviceModel: this.props.modelManager.Param.deviceModel,
        ...
        key: 'initEditForm',
        value: function initEditForm(text) {
        ...
        value: function dealColumns() {
            var columns = this.props.modelManager.TableColumns.tableColumns;
            var that = this;
                ...
                if (item.dataIndex == '') {
                    item.render = function (text) {
                        return _react2.default.createElement(
                            ...
                            { to: '/sys/modal/edit/' + text.firm + '/' + text.brand,
                                onClick: that.initEditForm.bind(that, text) },
                            '\u7F16\u8F91'
                        );
                    };
                }
        ...
        value: function downloadExcle() {
            ...
            this.fileName = (0, _channelManagerUtil.getDownloadName)(fileNameParam);
            var postData = {
                appCode: this.props.modelManager.Param.appCode,
                deviceModel: this.props.modelManager.Param.deviceModel,
                firm: this.props.modelManager.Param.firm,
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            _antd.Button,
                            { type: 'primary', icon: 'download', onClick: this.downloadExcle.bind(this) },
                            '\u4E0B\u8F7D\u62A5\u8868'
                        )
                    ),
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(ModelManager);
