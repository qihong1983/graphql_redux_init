		...
		return (
			...
			<Layout  style={{marginLeft: 180,position: "relative", marginTop:60, overflow:"hidden"}}>
			            ...
			            <Content style={{ background: '#fff', padding: "24px", margin: 24, marginTop:"24px", minHeight: 280  }}>
			            	...
			            	<Card title="修改用户" bordered={false} style={{ width: "100%" }} noHovering={true}>
								<Form layout={"horizontal"} onSubmit={this.handleSubmit.bind(this)} style={{maxWidth:"700px"}}>
							        ...
							        <FormItem label="模块权限" {...formItemLayout}>
							         ...
							         <FormItem style={{textAlign:"center"}}>
									    ...
									    <ButtonGroup>
									      ...
									      <Button type="reset" onClick={this.cancelForm.bind(this)} >取消</Button>
