...
module.exports = {
    ...
    entry: {
        ...
        vendor: ['react', 'prop-types', 'redux', 'react-router-redux', 'redux-thunk', 'react-router', 'antd', 'mockjs', 'echarts', 'js-export-excel-react', 'immutable', 'redux-immutable'] //提取react模块作为公共的js文件
    },
    output: {
